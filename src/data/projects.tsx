...
export const projects: Project[] = [
	{
		...
		images: [
			'/nexatech/nexatech1.webp',
			'/nexatech/nexatech2.webp',
			'/nexatech/nexatech3.webp',
			'/nexatech/nexatech4.webp',
			'/nexatech/nexatech5.webp',
			'/nexatech/nexatech6.webp',
		],
	...
	},
	{
		...
		images: ['/aurora/aurora1.webp', '/aurora/aurora2.webp'],
		type: ['Team', 'Fullstack', 'AI'],
