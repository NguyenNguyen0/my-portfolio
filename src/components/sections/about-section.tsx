...
function CategoryFilter({
	...
	return (
		<div className="flex flex-wrap gap-2 mb-6">
			{(Object.entries(CAT_COLORS) as [Category, string][]).map(
				([cat, color]) => {
		...
		<div className="flex-1 min-w-0 p-6 sm:p-8">
			...
			<div className="border-l-2 border-secondary pl-4 mb-5">
				<p className="font-mono-custom text-sm text-muted-foreground leading-relaxed">
					Full-Stack Developer specializing in distributed systems,
					AI-powered applications, and cloud-native deployments.
					Builds end-to-end — microservices to LLM agents, Kafka
					pipelines to React interfaces — and ships to production on
					AWS.
				</p>
			</div>
	...
	return (
		...
		>
			...
			<div
				...
				style={{
					backgroundImage:
						'radial-gradient(circle, oklch(60% 0 0 / 0.09) 1px, transparent 1px)',
			...
			<div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-20">
				...
				>
					<div
						...
						style={{
							background:
								'linear-gradient(180deg, color-mix(in oklch, var(--foreground) 10%, var(--card)) 0%, var(--card) 100%)',
						}}
					>
						<Image
